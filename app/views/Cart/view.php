            ...
            <?php if (!empty($_SESSION['cart'])): ?>
                ...
                <form class="row g-3" method="post" action="cart/checkout">
                    ...
                    <?php if (!isset($_SESSION['user'])): ?>
                        ...
                        <div class="col-md-6 offset-md-3">
                            <div class="form-floating mb-3">
                                <input type="password" name="password" class="form-control" id="password" placeholder="password" value="<?= get_field_value('password') ?>" required>
                        ...
                        <div class="col-md-6 offset-md-3">
                            <div class="form-floating mb-3">
                                <input required type="text" name="name" class="form-control" id="name" placeholder="Name" value="<?= get_field_value('name') ?>">
                        ...
                        <div class="col-md-6 offset-md-3">
                            <div class="form-floating mb-3">
                                <input required type="text" name="address" class="form-control" id="address" placeholder="Address" value="<?= get_field_value('address') ?>">
